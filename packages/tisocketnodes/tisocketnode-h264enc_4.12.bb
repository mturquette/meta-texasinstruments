...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-h264enc-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/video/node/h264/enc/... DSP-MM-TID-IMVID_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/video/node/h264/enc/out/omap3430/${RELEASE}/h264venc_sn.dll64P ${D}${base_libdir}/dsp
}
