...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-ilbcenc-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/speech/node/iLBC/enc/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	      element * /main/LATEST%"
...
#do_stage() {
#	install -d ${STAGING_BINDIR}/dspbridge/Codecs/speech/node/iLBC/enc
#	install -m 0644 ${S}/speech/node/iLBC/enc/* ${STAGING_BINDIR}/dspbridge/Codecs/speech/node/iLBC/enc
...
do_install() {
	...
	install -m 0644 ${S}/speech/node/iLBC/enc/out/omap3430/${RELEASE}/ilbcenc_sn.dll64P ${D}${libdir}/dsp
