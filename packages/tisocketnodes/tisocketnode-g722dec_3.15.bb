...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-g722dec-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/speech/node/g722/dec/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/speech/node/g722/dec/out/omap3430/${RELEASE}/g722dec_sn.dll64P ${D}${base_libdir}/dsp
