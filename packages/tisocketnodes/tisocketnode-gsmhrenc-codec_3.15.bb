PRIORITY = "optional"
DESCRIPTION = "Texas Instruments GSM Half-Rate Encoder Socket Node Codec."
LICENSE = "LGPL"
PR = "r0"
DEPENDS = "baseimage"

CCASE_SPEC = "%\
	element /vobs/wtbu/CSSD_MM_Releases/Codecs/speech/hr_enc/c64x/mm_tiicodecs/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	element * /main/LATEST%"

CCASE_PATHFETCH = "/vobs/wtbu/CSSD_MM_Releases/Codecs/speech/hr_enc/c64x/mm_tiicodecs/"
...
do_stage() {
	install -d ${STAGING_BINDIR}/dspbridge/Codecs/speech/hr_enc/c64x/mm_tiicodecs/100_S_GSMHR_X_ALL_c64x+_1_10
	cp -a ${S}/100_S_GSMHR_X_ALL_c64x+_1_10/* ${STAGING_BINDIR}/dspbridge/Codecs/speech/hr_enc/c64x/mm_tiicodecs/100_S_GSMHR_X_ALL_c64x+_1_10
