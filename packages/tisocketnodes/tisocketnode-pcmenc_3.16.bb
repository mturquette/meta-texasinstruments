...
CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/audio/node/pcm/enc/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/audio/node/pcm/enc/out/omap3430/${RELEASE}/pcme_tn.dll64P ${D}${base_libdir}/dsp
}
