...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-jpegdec-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/image/node/jpeg/dec/... DSP-MM-TID-IMAGE_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/image/node/jpeg/dec/out/omap3430/${RELEASE}/jpegdec_sn.dll64P ${D}${libdir}/dsp
