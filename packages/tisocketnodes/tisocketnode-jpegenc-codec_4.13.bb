...
CCASE_SPEC = "%\
	element /vobs/wtbu/CSSD_MM_Releases/Codecs/image/jpeg_enc/c64x/mm_tiicodecs/... DSP-MM-TID-IMVID_RLS_${PV}%\
	element * /main/LATEST%"
...
do_unpack2() {
	unzip 100E_I_JPEG_E_BL_c64x+_1_05.zip
	unzip 100_I_JPEG_E_BL_c64x+_1_05.zip
}

do_stage() {
	install -d ${STAGING_BINDIR}/dspbridge/Codecs/image/jpeg_enc/c64x/mm_tiicodecs/100E_I_JPEG_E_BL_c64x+_1_05
        cp -a ${S}/100E_I_JPEG_E_BL_c64x+_1_05/* ${STAGING_BINDIR}/dspbridge/Codecs/image/jpeg_enc/c64x/mm_tiicodecs/100E_I_JPEG_E_BL_c64x+_1_05
