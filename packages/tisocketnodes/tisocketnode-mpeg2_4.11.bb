...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-mpeg2-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/video/node/mpeg2/... DSP-MM-TID-IMVID_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/video/node/mpeg2/dec/out/omap3430/${RELEASE}/mp2vdec_sn.dll64P ${D}${base_libdir}/dsp
