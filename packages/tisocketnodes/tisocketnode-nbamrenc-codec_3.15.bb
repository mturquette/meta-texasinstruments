PRIORITY = "optional"
DESCRIPTION = "Texas Instruments NB-AMR Encoderr Socket Node Codec."
LICENSE = "LGPL"
PR = "r0"
DEPENDS = "baseimage"

CCASE_SPEC = "%\
	element /vobs/wtbu/CSSD_MM_Releases/Codecs/speech/nbamr_enc/c64x/mm_tiicodecs/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	element * /main/LATEST%"

CCASE_PATHFETCH = "/vobs/wtbu/CSSD_MM_Releases/Codecs/speech/nbamr_enc/c64x/mm_tiicodecs/"
...
do_stage() {
	install -d ${STAGING_BINDIR}/dspbridge/Codecs/speech/nbamr_enc/c64x/mm_tiicodecs/230_S_GSM_X_AMR_c64x+_1_05
	cp -a ${S}/230_S_GSM_X_AMR_c64x+_1_05/* ${STAGING_BINDIR}/dspbridge/Codecs/speech/nbamr_enc/c64x/mm_tiicodecs/230_S_GSM_X_AMR_c64x+_1_05
