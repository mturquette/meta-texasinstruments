...
CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/video/node/wmv9/dec/... DSP-MM-TII-IMVID_RLS_${PV}%\
	      element /vobs/wtbu/OMAPSW_DSP/video/node/wmv9/dec_pplibs_configs/... DSP-MM-TII-IMVID_RLS_${PV}%\
	      element * /main/LATEST%"
