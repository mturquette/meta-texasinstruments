...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-wma9-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/audio/node/wma9/dec/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/audio/node/wma9/dec/out/omap3430/${RELEASE}/wmadec_sn.dll64P ${D}${base_libdir}/dsp
