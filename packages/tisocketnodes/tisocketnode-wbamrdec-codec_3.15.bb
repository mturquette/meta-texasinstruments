...
CCASE_SPEC = "%\
	element /vobs/wtbu/CSSD_MM_Releases/Codecs/speech/wbamr_dec/c64x/mm_tiicodecs/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	element * /main/LATEST%"

CCASE_PATHFETCH = "/vobs/wtbu/CSSD_MM_Releases/Codecs/speech/wbamr_dec/c64x/mm_tiicodecs/"
...
do_stage() {
	install -d ${STAGING_BINDIR}/dspbridge/Codecs/speech/wbamr_dec/c64x/mm_tiicodecs/210_S_G722_2_X_ALL_c64x+_1_05
	cp -a ${S}/210_S_G722_2_X_ALL_c64x+_1_05/* ${STAGING_BINDIR}/dspbridge/Codecs/speech/wbamr_dec/c64x/mm_tiicodecs/210_S_G722_2_X_ALL_c64x+_1_05
