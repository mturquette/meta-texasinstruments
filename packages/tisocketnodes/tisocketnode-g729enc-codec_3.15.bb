PRIORITY = "optional"
DESCRIPTION = "Texas Instruments G729 Encoder Socket Node Codec."
LICENSE = "LGPL"
PR = "r0"
DEPENDS = "baseimage"

CCASE_SPEC = "%\
	      element /vobs/wtbu/CSSD_MM_Releases/Codecs/speech/g729_enc/c64x/mm_tiicodecs/... DSP-MM-TID-AUDIO_RLS_${PV}%\
	      element * /main/LATEST%"

CCASE_PATHFETCH = "/vobs/wtbu/CSSD_MM_Releases/Codecs/speech/g729_enc/c64x/mm_tiicodecs"
...
do_stage() {
	install -d ${STAGING_BINDIR}/dspbridge/Codecs/speech/g729_enc/c64x/mm_tiicodecs/g729ab_x_all_c64xplus
	cp -a ${S}/g729ab_x_all_c64xplus/* ${STAGING_BINDIR}/dspbridge/Codecs/speech/g729_enc/c64x/mm_tiicodecs/g729ab_x_all_c64xplus
