...
DEPENDS = "baseimage \
	   tisocketnode-ringio \
	   tisocketnode-usn \
	   tisocketnode-spark-codec"

CCASE_SPEC = "%\
	      element /vobs/wtbu/OMAPSW_DSP/video/node/spark/... DSP-MM-TID-IMVID_RLS_${PV}%\
	      element * /main/LATEST%"
...
do_install() {
	...
	install -m 0644 ${S}/video/node/spark/dec/out/omap3430/${RELEASE}/sparkdec_sn.dll64P ${D}${base_libdir}/dsp
}
