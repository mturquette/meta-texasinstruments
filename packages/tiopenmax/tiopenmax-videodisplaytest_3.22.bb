DESCRIPTION = "Texas Instruments OpenMAX IL Video Display Test Application."
DEPENDS = "tidspbridge-lib tiopenmax-core tiopenmax-lcml tiopenmax-rmproxy tiopenmax-resourcemanager tiopenmax-postproc tiopenmax-videodec"
PR = "r0"
...
SRC_URI = "\
	file://23.16-videodisnocore.patch;patch=1 \
...
do_compile() {
	cd ${S}/application/src/openmax_il/video_display
	oe_runmake \
