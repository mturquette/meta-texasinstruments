...
DEPENDS = "tidspbridge-lib tiopenmax-core tiopenmax-lcml tiopenmax-rmproxy tiopenmax-resourcemanager tiopenmax-common"
PR = "r0"
...
SRC_URI = "\
	file://23.13-mp3decnocore.patch;patch=1 \
	file://23.13-mp3decnoincinstall.patch;patch=1 \
	file://23.13-mp3dectestnocore.patch;patch=1 \
	"
...
do_install_cleanup() {
	mv ${D}/omx/audio_decoder.mp3* ${D}/omx/patterns
}
