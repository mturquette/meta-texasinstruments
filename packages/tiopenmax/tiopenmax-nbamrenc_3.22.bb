...
do_compile() {
	cd ${S}/audio/src/openmax_il/nbamr_enc
	rm inc/TIDspOmx.h
...
do_install_cleanup() {
	${@base_contains("DISTRO_FEATURES", "testpatterns", "mv ${D}${bindir}/audio_encoder.amrnb* ${D}/usr/omx/patterns", "echo nothing to do here!", d)}
}
