DESCRIPTION = "Texas Instruments OpenMAX IL Video Capture Test Application."
DEPENDS = "tidspbridge-lib tiopenmax-core tiopenmax-lcml tiopenmax-resourcemanager tiopenmax-rmproxy tiopenmax-videoenc tiopenmax-camera"
PR = "r0"
...
SRC_URI = "\
	file://23.16-videocapnocore.patch;patch=1 \
...
do_compile() {
	cd ${S}/application/src/openmax_il/video_capture
	oe_runmake \
