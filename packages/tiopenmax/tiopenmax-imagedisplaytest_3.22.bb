DESCRIPTION = "Texas Instruments OpenMAX IL Image Display Test Application."
DEPENDS = "tidspbridge-lib tiopenmax-core tiopenmax-lcml tiopenmax-rmproxy tiopenmax-resourcemanager tiopenmax-rmproxy tiopenmax-postproc tiopenmax-prepostproc tiopenmax-jpegdec"
PR = "r0"
...
SRC_URI = "\
	file://23.16-imagedisnocore.patch;patch=1 \
...
do_compile() {
	cd ${S}/application/src/openmax_il/image_display
	oe_runmake \
