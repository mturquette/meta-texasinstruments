...
BTFM_23.15_RELEASE_PV = "23.15.0"

CCASE_SPEC =   "%\
	element /vobs/WCGDev/... LINUX-WCG-BT_RLS_${BTFM_23.15_RELEASE_PV}%\
        element /vobs/MCP_Common/... LINUX-WCG-BT_RLS_${PV}%\
	element /vobs/MCP_Common/... LINUX-WCG-BT_RLS_${BTFM_23.15_RELEASE_PV}%\
	element /vobs/HSW_FMStack/... LINUX-WCG-BT_RLS_${BTFM_23.15_RELEASE_PV}%\
	element * /main/LATEST %\
	"
